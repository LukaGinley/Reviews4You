...
function createPagination($pno,$pcurr)
{
    ...
    <li id="sq-prev">
    <button class="btn btn-dark" data-toggle="tooltip" data-placement="bottom" data-original-title="Previous Page >>">
    	{$tprevitem}
    </button>
    </li>
    ...
    <li id="sq-next">
    <button class="btn btn-dark" data-toggle="tooltip" data-placement="bottom" data-original-title="Next Page >>">
        {$tnextitem}
    </button>
    </li>
